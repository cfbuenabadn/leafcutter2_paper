...
if (length(tissues) == 0){                          
    file.create(glue('results/coloc/hyprcoloc_results_allTissues/tables/temp/{gwas_loci}.tsv'))                          
                          
    saveRDS(list(betas = NULL, ses=NULL, traits=NULL, rsid=NULL, hyprcoloc_results=NULL), 
           glue('results/coloc/hyprcoloc_results_allTissues/rds/{gwas_loci}.rds'))   
    } else {
...
if (is.null(X_SummaryStats) | (length(X_SummaryStats) == 0))  {
    ...
    write_tsv(res$results, glue('results/coloc/hyprcoloc_results_allTissues/tables/temp/{gwas_loci}.tsv'))                          
